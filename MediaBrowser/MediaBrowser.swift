...
//        navigationController?.view.backgroundColor = UIColor.white
    ...
    open override func viewDidLoad() {
        ...
        print("MeidaBrowser viewDidLoad...")
...
//        }
    ...
    open func performLayout() {
        ...
        if let navi = navigationController {
            ...
            self.navigationItem.leftBarButtonItem = UIBarButtonItem.init(
                image: UIImage.imageForResourcePath(name: "icon_back", inBundle: Bundle(for: MediaBrowser.self)),
                style: .plain,
                target: self,
    ...
    open func updateNavigation() {
        ...
        if let gc = gridController {
            ...
            if nil == title {
                title = "\(currentPageIndex + 1) \("/") \(numberOfMedias)"
            }
        } else {
            title = nil
        }
